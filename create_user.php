...
if($num_row >= 1){//ถ้ามีข้อมูลมากกว่าหรือเท่ากับ 1 แสดงว่า username นั้นมีการใช้งานแล้ว
  ...
  //แสดงข้อความค้างไว้ 2 วินาทีแล้วให้ไปหน้า register
  header( 'refresh: 2; url=/student/register.php' );
}else{//ถ้าไม่ข้อมูล Username ที่รับเข้ามามีน้อยกว่า 1 แสดงว่า Username นี้ยังไม่มีผู้ใช้งาน
