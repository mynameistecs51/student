...
if(!empty($num_rows)){ //ถ้าข้อมูลไม่เท่ากับค่าว่างหรือเท่าไม่เท่ากับ 0
...
}else{ //ถ้า login ไม่สำเร็จ ให้แสดงข้อความ Username หรือ Password ไม่ถูกต้อง !!
  echo "Username หรือ Password ไม่ถูกต้อง !!";

//ค้าหน้าแสดงข้อความไว้ 2 วินาที แล้วไปหน้า login
